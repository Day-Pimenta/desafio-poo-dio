...
public class Main {
    public static void main(String[] args) {
        ...
        mentoria1.setDescricao("Mentoria ao vivo com Camila");
        ...
        bootcamp.setDescircao("Bootcamp desafiando o JAVA");
        bootcamp.getConteudos().add(curso1);
        bootcamp.getConteudos().add(curso2);
        bootcamp.getConteudos().add(mentoria1);

        Dev dev1 = new Dev();
        dev1.setNome("Dayanne Pimenta");
        ...
        System.out.println("Conteúdos Inscritos "+ dev2.getNome()+" "+ dev2.getConteudosInscritos());
        System.out.println("Conteúdos Concluidos "+dev2.getNome()+" "+  dev1.getConteudosConcluidos());
